...
function Benefits() {
    ...
    return (
        <div className="relative p-4">
            ...
            <div className="-z-0 relative overflow-hidden w-full md:w-5/6 rounded-3xl  hover:bg-gray-100 md:left-32 ">
                ...
                <button
                    onClick= {handlePrev}
                    className="-z-0 md:h-28 md:w-10 absolute top-1/2 left-2 transform -translate-y-1/2 text-black p-2 rounded-full bg-gray-300 hover:shadow-lg hover:shadow-gray-900 " 
                >
                    &lt;
                </button>
                <button
                    onClick={handleNext}
                    className="-z-0 md:h-28 md:w-10 absolute top-1/2 right-2 transform -translate-y-1/2 text-black p-2 rounded-full bg-gray-300 hover:shadow-lg hover:shadow-gray-900 "
                >
                    &gt;
                </button>
            </div>
