...
export default function EventRegistration() {
    ...
    return (
        ...
        <div className="min-h-screen ">
            ...
            <div className="flex bg-primary-background flex-col sm:flex-row">
                {/* left */}
                <div className="sm:w-[39vw] sm:h-[calc(100vh-5rem)] bg-primary-background flex sm:flex-col items-center justify-evenly gap-4 p-2">
                    <div className="sm:h-sm">
                        <img className="h-[6rem] sm:h-auto" src={TeamImg} alt="" />
                    </div>
                    <div>
                        <h1 className="text-white text-3xl sm:text-5xl font-bold text-center">IEEE Startup Tech</h1>
                        <h1 className="text-white text-3xl sm:text-5xl font-bold text-center">Pitch Competition</h1>
                    </div>
                </div>
                ...
                {registered ? (
                    <div className="flex w-full justify-center items-center h-[65vh] sm:h-screen bg-white">
                        <h1 className="text-2xl text-center text-primary-background">Registered Successfully.</h1>
                    </div>
                ) : (
                    <>
