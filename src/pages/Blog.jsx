   ...
   <div className="container mx-auto p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {members.map((member, index) => (
          <div key={index} className="flex justify-center bg-white p-4 hover:shadow-md ">
            <img src={member.imgPath} alt={member.name} className="relative left:15 md:left-12 object-cover h-28 m-1 w-28 border rounded-full" />
            <div className="p-4">
